...
typdef struct mqtt_ack mqtt_puback;
typdef struct mqtt_ack mqtt_pubrec;
typdef struct mqtt_ack mqtt_pubrel;
typdef struct mqtt_ack mqtt_pubcomp;
typdef struct mqtt_ack mqtt_unsuback;
typdef union mqtt_header mqtt_pingreq;
typdef union mqtt_header mqtt_pingresp;
typdef union mqtt_header mqtt_disconnect;
...
union mqtt_header *mqtt_packer_header(unsigned char);
struct mqtt_ack *mqtt_packer_ack(unsigned char, unsigned short);
struct mqtt_connack *mqtt_packer_connack(unsigned char, unsigned char, unsigned char);
struct mqtt_suback *mqtt_packer_suback(unsigned char, unsigned short, unsigned char *, unsigned short);
struct mqtt_publish *mqtt_packer_publish(unsigned char, unsigned short, size_t, unsigned char *, size_t, unsigned char *);
